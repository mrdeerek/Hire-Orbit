  ...
  return (
    <div>
      <div className="mx-auto max-w-7xl">
        <div className="lg:flex items-end dark:border-white justify-between border-b border-gray-200 pt-2 pb-4 lg:pt-14">
          <h1 className="lg:text-4xl text-3xl mb-2 lg:mb-0 dark:text-white font-bold tracking-tight text-gray-900">
